...
from collector.openstack.common.gettextutils import _LW
from collector.openstack.common import log as logging
from collector.openstack.common.rpc import matchmaker as mm
...
matchmaker_opts = [
    ...
    cfg.StrOpt('ringfile',
               ...
               default='/etc/collector/matchmaker_ring.json',
