...
from collector.openstack.common.gettextutils import _, _LE
from collector.openstack.common import importutils
from collector.openstack.common import jsonutils
from collector.openstack.common import local
from collector.openstack.common import log as logging
from collector.openstack.common import versionutils
...
The current message format (version 2.0) is very simple.  It is::
    ...
    {
        'collector.version': <RPC Envelope Version as a String>,
        'collector.message': <Application Message Payload, JSON encoded>
    }
...
_VERSION_KEY = 'collector.version'
_MESSAGE_KEY = 'collector.message'
